...
function renderTitulosEstadisticaPanel() {
  ...
  if (!panel) return;
  const msg =
    titulosEstadisticaTab === "dia"
      ? "Todavía no hay títulos por día. En cuanto se calculen a partir de las estadísticas diarias, van a aparecer acá."
      : "Todavía no hay títulos totales. En cuanto se calculen a partir del acumulado del viaje, van a aparecer acá.";
  panel.innerHTML = `
